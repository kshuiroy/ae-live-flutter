...
///
/// To show a [OpenSourceLicensesWidget], use [showLicensePage].
///
/// The [AboutDialog] shown by [showAboutDialog] and [AboutListTile] includes
/// a button that calls [showLicensePage].
///
/// The licenses shown on the [OpenSourceLicensesWidget] are those returned by the
/// [LicenseRegistry] API, which can be used to add more licenses to the list.
class OpenSourceLicensesWidget extends StatefulWidget {
  ...
  /// The licenses shown on the [OpenSourceLicensesWidget] are those returned by the
  /// [LicenseRegistry] API, which can be used to add more licenses to the list.
  const OpenSourceLicensesWidget({
    super.key,
  ...
  @override
  State<OpenSourceLicensesWidget> createState() =>
      _OpenSourceLicensesWidgetState();
}

class _OpenSourceLicensesWidgetState extends State<OpenSourceLicensesWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return _MasterDetailFlow(
      ...
      title: Text(t.settings.more.license),
...
class _PackageLicensePageState extends State<_PackageLicensePage> {
  ...
  Widget build(BuildContext context) {
    ...
    final EdgeInsets padding = EdgeInsets.only(
      left: pad,
      right: pad,
      bottom: MediaQuery.of(context).padding.bottom + pad,
    );
